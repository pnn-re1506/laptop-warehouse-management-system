...
public class UpdateSupplier extends javax.swing.JDialog {
    ...
    public UpdateSupplier(javax.swing.JInternalFrame parent,javax.swing.JFrame owner, boolean modal) {
        super(owner, modal);
    ...
    private UpdateSupplier(JFrame jFrame, boolean b) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            ncc.setSupplierId(txtMaNhaCungCap.getText());
            ncc.setSupplierName(txtTenNhaCungCap.getText());
            ncc.setPhone(txtphone1.getText());
            ncc.setAddress(txtDiaChi.getText());
