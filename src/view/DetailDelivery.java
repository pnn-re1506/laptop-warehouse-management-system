...
public class DetailDelivery extends javax.swing.JDialog {
    ...
    public DetailDelivery(javax.swing.JInternalFrame parent, javax.swing.JFrame owner, boolean modal) {
        super(owner, modal);
        this.parent = (DeliveryForm) parent;
        initComponents();
        setLocationRelativeTo(null);
        ExportReceipt ex = this.parent.getExReceiptSelect();
        labelMaPhieu.setText(ex.getReceiptID());
        labelNguoiTao.setText(AccountDAO.getInstance().selectById(ex.getCreatedBy()).getFullName());
        labelTongTien.setText(this.parent.getFormatter().format(ex.getTotalAmount()) + "đ");
        labelThoiGianTao.setText(this.parent.getFormatDate().format(ex.getCreatedDate()));
    ...
    public void loadDataToTableProduct() {
        try {
            ArrayList<ReceiptDetail> DetailReceipt = ExportDetailDAO.getInstance().selectAll(this.parent.getExReceiptSelect().getReceiptID());
    ...
    private void initComponents() {
        ...
        setTitle("Delivery Note Details");
        ...
        jLabel1.setText("Delivery Note Details");
        ...
        tblChiTietPhieu.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.", "Product ID", "Product Name", "Quantity", "Unit Price", "Total Price"
            }
        ));
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/pdf-file.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        writepdf.writeDelivery(this.parent.getExReceiptSelect().getReceiptID());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetailDelivery.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
