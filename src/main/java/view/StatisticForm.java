...
public class StatisticForm extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 1167,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jComboBoxLuaChon1.setModel(
                new javax.swing.DefaultComboBoxModel<>(new String[] { "All", "FullName", "UserName", "Role" }));
    ...
    private void tblAccountMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_tblAccountMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            if (tblAccount.getSelectedRow() == -1) {
                ...
                acc = new DetailStatisticAcc(this, (JFrame) javax.swing.SwingUtilities.getWindowAncestor(this),
        ...
        try {
            ...
            for (Account i : acc) {
                tblModelAcc.addRow(new Object[] {
                        i.getFullName(), i.getEmail(), i.getUserName(), i.getRole(),
                        i.getStatus() == 1 ? "Active" : "Locked"
                });
            }
        } catch (Exception e) {
        }
    ...
    private void loadDataToTableThongKeProduct(ArrayList<ProductStatistics> stas) {
        try {
            ...
            for (int i = 0; i < stas.size(); i++) {
                tblModelAcc.addRow(new Object[] {
                        (i + 1), stas.get(i).getProductId(), stas.get(i).getProductName(),
                        stas.get(i).getImportQuantity(), stas.get(i).getExportQuantity()
                });
            }
    ...
    private ArrayList<ProductStatistics> searchProductNameStatistic(ArrayList<ProductStatistics> arr, String name) {
        ...
        for (ProductStatistics i : arr) {
            if (i.getProductId().toLowerCase().contains(name.toLowerCase())
                    || i.getProductName().toLowerCase().contains(name.toLowerCase())) {
                result.add(i);
            }
        }
        return result;
    ...
    private void loadMonthlyStatistics() {
        try {
            List<MonthlyStatisticsDAO.MonthlyData> monthlyStats = MonthlyStatisticsDAO.getInstance()
    ...
    /**
     * Update existing chart with new year data or show message if chart not
     * available
     */
