...
public class Manage extends javax.swing.JFrame {
    ...
    public Manage() throws UnsupportedLookAndFeelException {
    ...
    private void preloadPages() {
        ...
        preloadPage("receipts", () -> new ReceiptForm(this.getCurrentAcc()), 450);
        ...
        preloadPage("deliveries", () -> new DeliveryForm(this.getCurrentAcc()), 900);
        preloadPage("statistics", StatisticForm::new, 1050);
    }
    ...
    private void initComponents() {
        ...
        NavbarMenu.add(DangXuat, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 680, 240, -1));
        ...
        NavbarMenu.add(Account, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 490, 240, -1));
    ...
    private void PhieuNhapMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PhieuNhapMouseClicked
        // TODO add your handling code here:
        showCachedPage("receipts", () -> new ReceiptForm(this.getCurrentAcc()));
    ...
    private void PhieuXuatMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PhieuXuatMouseClicked
        // TODO add your handling code here:
        showCachedPage("deliveries", () -> new DeliveryForm(this.getCurrentAcc()));
