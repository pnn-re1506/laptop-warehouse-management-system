...
public class InventoryForm extends javax.swing.JInternalFrame {
    ...
    public final void initTable() {
        ...
        String[] headerTbl = new String[]{"Product ID", "Product Name", "Quantity","CPU","Graphics Card", "RAM", "Storage", "Type"};
    ...
    public void loadDataToTable() {
        try {
            ...
            ArrayList<Computer> armt = mtdao.selectAllE();
    ...
    private void initComponents() {
        ...
        jComboBoxLuaChon.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "All", "Product ID", "Product Name", "Quantity", "RAM", "CPU", "Storage", "Graphics Card" }));
