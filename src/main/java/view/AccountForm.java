...
public class AccountForm extends javax.swing.JInternalFrame {
        ...
        try {
            ...
            for (Account i : acc) {
                tblModel.addRow(new Object[] {
                        i.getFullName(), i.getUserName(), i.getEmail(), i.getRole(),
                        i.getStatus() == 0 ? "Locked" : "Active"
                });
            }
        } catch (Exception e) {
        }
    ...
    private void initComponents() {
        ...
        cbxLuachon.setModel(
                new javax.swing.DefaultComboBoxModel<>(new String[] { "All", "Full Name", "User Name", "Role", " " }));
    ...
    private void btnEditAccountActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnEditAccountActionPerformed
        ...
        if (tblAccount.getSelectedRow() == -1) {
            ...
            if (getAccountSelect().getRole().equals("Admin")) {
                JOptionPane.showMessageDialog(this, "You cannot edit the admin account here!", "Warning",
                        JOptionPane.WARNING_MESSAGE);
            } else {
                UpdateAccount u = new UpdateAccount(this, (JFrame) javax.swing.SwingUtilities.getWindowAncestor(this),
    ...
    private void btnDeleteAccountActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnDeleteAccountActionPerformed
        ...
        if (tblAccount.getSelectedRow() == -1) {
            ...
            if (select.getRole().equals("Admin")) {
                ...
                int checkVl = JOptionPane.showConfirmDialog(this, "Are you sure you want to delete this account?",
    ...
    private void btnEditAccount1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnEditAccount1ActionPerformed
        ...
        if (tblAccount.getSelectedRow() == -1) {
            ...
            int check = JOptionPane.showConfirmDialog(this, "Do you want to reset the password for this account?",
